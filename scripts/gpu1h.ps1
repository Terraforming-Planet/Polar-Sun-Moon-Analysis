...
try {
    ...
    # Critical: stdout + stderr from the native Python runner are captured from byte one.
    ...
    # Stop transcript before hashing so the transcript itself is final and hashable.
