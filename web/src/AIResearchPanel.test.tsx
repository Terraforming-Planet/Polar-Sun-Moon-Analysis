...
describe('AIResearchPanel', () => {
  it('renders the advanced research workspace with the privacy-first entry flow', () => {
    ...
    expect(html).toContain('1972 → today')
    expect(html).toContain('1990 → today')
    expect(html).toContain('2015 → today')
    expect(html).toContain('seasons')
    expect(html).toContain('exact date + time')
    expect(html).toContain('23 July 1972')
    expect(html).toContain('<b>Seasonal</b>')
    expect(html).not.toContain('Exact day')
