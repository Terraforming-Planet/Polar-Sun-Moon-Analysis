...
describe('AIResearchPanel', () => {
  it('renders the advanced research workspace with the privacy-first entry flow', () => {
    ...
    expect(html).toContain('1972 → dziś')
    expect(html).toContain('1990 → dziś')
    expect(html).toContain('2015 → dziś')
    expect(html).toContain('pory roku')
    expect(html).toContain('dokładna data + godzina')
    expect(html).toContain('23.07.1972')
    expect(html).toContain('Tryb <b>Pory roku</b>')
    expect(html).not.toContain('Dokładny dzień')
    expect(html).not.toContain('Godzina UTC')
  ...
  it('renders contest quick access while keeping the advanced laboratory reachable', () => {
    ...
    expect(html).toContain('1972 → dziś')
    expect(html).toContain('własny zakres')
    expect(html).toContain('pory roku')
    expect(html).toContain('dokładna data + godzina')
