...
describe('AIResearchPanel', () => {
  it('renders the English research console and keeps user prompt privacy explicit', () => {
    ...
    expect(html).toContain('your question text is never written to the research archive or localStorage')
    expect(html).toContain('Refreshing or closing the tab removes the private conversation')
    expect(html).toContain('Assistant answers/reports are archived locally without the matching prompt')
