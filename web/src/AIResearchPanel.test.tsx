...
describe('AIResearchPanel', () => {
  ...
  it('renders a locked simple-only experience with every contest quick-access destination visible', () => {
    ...
    expect(html).toContain('href="/experiment-001/"')
    expect(html).toContain('href="/flood-map/"')
    expect(html).toContain('href="/reports/copernicus-analysis.html"')
    expect(html).toContain('Wpisz miejsce. Resztę przygotuje system.')
    expect(html).toContain('Zapytaj asystenta')
