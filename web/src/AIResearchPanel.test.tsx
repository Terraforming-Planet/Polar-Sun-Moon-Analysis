...
describe('AIResearchPanel', () => {
  it('renders the advanced research workspace with the privacy-first entry flow', () => {
    ...
    expect(html).toContain('Asystent dostaje wybrane miejsce, promień, okres')
    expect(html).toContain('Wyślij prywatnie')
    expect(html).toContain('1990–dziś')
    expect(html).toContain('Promień badanego obszaru')
    expect(html).toContain('Czyste do badania rzek')
    expect(html).toContain('Pochmurne / wszystkie')
